...
LEECH_COMMAND = os.environ.get("LEECH_COMMAND", "leech@ayushleechx2bot")
LEECH_UNZIP_COMMAND = os.environ.get("LEECH_UNZIP_COMMAND", "leechunzip@ayushleechx2bot")
LEECH_ZIP_COMMAND = os.environ.get("LEECH_ZIP_COMMAND", "leechzip@ayushleechx2bot")
GLEECH_COMMAND = os.environ.get("GLEECH_COMMAND", "gleech@ayushleechx2bot")
GLEECH_UNZIP_COMMAND = os.environ.get("GLEECH_UNZIP_COMMAND", "gleechunzip@ayushleechx2bot")
GLEECH_ZIP_COMMAND = os.environ.get("GLEECH_ZIP_COMMAND", "gleechzip@ayushleechx2bot")
YTDL_COMMAND = os.environ.get("YTDL_COMMAND", "ytdl@ayushleechx2bot")
GYTDL_COMMAND = os.environ.get("GYTDL_COMMAND", "gytdl@ayushleechx2bot")
RCLONE_CONFIG = os.environ.get("RCLONE_CONFIG", "")
DESTINATION_FOLDER = os.environ.get("DESTINATION_FOLDER", "TorrentLeech-Gdrive")
INDEX_LINK = os.environ.get("INDEX_LINK", "")
TELEGRAM_LEECH_COMMAND = os.environ.get("TELEGRAM_LEECH_COMMAND", "tleech@ayushleechx2bot")
TELEGRAM_LEECH_UNZIP_COMMAND = os.environ.get(
    "TELEGRAM_LEECH_UNZIP_COMMAND", "tleechunzip@ayushleechx2bot"
)
CANCEL_COMMAND_G = os.environ.get("CANCEL_COMMAND_G", "cancel@ayushleechx2bot")
GET_SIZE_G = os.environ.get("GET_SIZE_G", "getsize")
STATUS_COMMAND = os.environ.get("STATUS_COMMAND", "status@ayushleechx2bot")
SAVE_THUMBNAIL = os.environ.get("SAVE_THUMBNAIL", "savethumb@ayushleechx2bot")
CLEAR_THUMBNAIL = os.environ.get("CLEAR_THUMBNAIL", "clearthumb@ayushleechx2bot")
UPLOAD_AS_DOC = os.environ.get("UPLOAD_AS_DOC", "False")
PYTDL_COMMAND = os.environ.get("PYTDL_COMMAND", "pytdl@ayushleechx2bot")
GPYTDL_COMMAND = os.environ.get("GPYTDL_COMMAND", "gpytdl@ayushleechx2bot")
LOG_COMMAND = os.environ.get("LOG_COMMAND", "log")
CLONE_COMMAND_G = os.environ.get("CLONE_COMMAND_G", "gclone@ayushleechx2bot")
UPLOAD_COMMAND = os.environ.get("UPLOAD_COMMAND", "upload")
RENEWME_COMMAND = os.environ.get("RENEWME_COMMAND", "renewme")
RENAME_COMMAND = os.environ.get("RENAME_COMMAND", "rename@ayushleechx2bot")
TOGGLE_VID = os.environ.get("TOGGLE_VID", "togglevid@ayushleechx2bot")
TOGGLE_DOC = os.environ.get("TOGGLE_DOC", "toggledoc@ayushleechx2bot")
RCLONE_COMMAND = os.environ.get("RCLONE_COMMAND", "rclone")
HELP_COMMAND = os.environ.get("HELP_COMMAND", "help@ayushleechx2bot")
